...
use zbus::{zvariant::{Type, OwnedValue, OwnedObjectPath}, dbus_proxy};
use serde::{Serialize, Deserialize};

// From https://www.freedesktop.org/software/systemd/man/org.freedesktop.systemd1.html :
//
//       ListUnits(out a(ssssssouso) units);
//
// ListUnits() returns an array of all currently loaded units. Note that units may be known by
// multiple names at the same name, and hence there might be more unit names loaded than actual
// units behind them. The array consists of structures with the following elements:
//
...
pub struct UnitListItem {
    ...
    pub i_dont_understand_this_field: String,
    pub owned_object_path: OwnedObjectPath,
    pub job_id: u32,
    pub job_type: String,
